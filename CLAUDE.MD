...
- Common attributes: `[Required]`, `[EmailAddress]`, `[MinLength]`, `[MaxLength]`
...
- **Main Branch**: `main`
- **Current Branch**: `youthful-kare`
- **Worktree Path**: `C:\Users\hoade\.claude-worktrees\beyond8-server\youthful-kare`
