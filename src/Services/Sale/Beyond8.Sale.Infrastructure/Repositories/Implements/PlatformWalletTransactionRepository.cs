...
public class PlatformWalletTransactionRepository(SaleDbContext context) : PostgresRepository<PlatformWalletTransaction>(context), IPlatformWalletTransactionRepository;